...
@media (max-width: 768px) {
  .todo-item {
    ...
    position: relative; /* Set relative positioning for todo-item */
  ...
  .actions {
    position: absolute; /* Set absolute positioning for actions */
    right: 0; /* Position actions to the right within the todo-item */
    top: 0; /* Position actions to the top within the todo-item */
    bottom: 0; /* Position actions to the bottom within the todo-item */
    display: flex;
    align-items: center; /* Center items vertically within the actions container */
  }
  .title {
    white-space: nowrap; /* Prevent text from wrapping */
